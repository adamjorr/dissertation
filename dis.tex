...
\gradmonth{December}
\gradyear{2020}
\chair{Reed Cartwright, Chair \\ Melissa Wilson\\ Kenro Kusumi\\ Jesse Taylor\\ Susanne Pfeifer}		
\maketitle
\doublespace
\include{abstract}
...
% \input{ch3/ch3}
\input{ch4/ch4}
\addtocontents{lof}{\protect\afterpage{\lhead{Figure~}}}
\input{ch5/ch5}
\input{ch6/ch6}
%-----------------------back matter
\newpage
